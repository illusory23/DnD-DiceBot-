        ...
        function addCombatant() {
            ...
            let dexMod = 0;
            if (selectedCharId) {
                const _cd = charCache[selectedCharId];
        ...
        function startCombat() {
            ...
            // 按先攻从高到低排序；平手时比较敏捷调整值，调整值高者优先
            combatants.sort((a, b) => (b.initiative - a.initiative) || ((b.dexMod || 0) - (a.dexMod || 0)));
        ...
        function confirmInitiative(index) {
            ...
            if (combatStarted && combatants.length > 1) {
                ...
                combatants.sort((a, b) => (_initVal(b) - _initVal(a)) || ((b.dexMod || 0) - (a.dexMod || 0)));
            }
