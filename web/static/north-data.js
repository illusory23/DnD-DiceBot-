...
(function () {
    ...
    var CTX = window.NORTH_CTX = window.NORTH_CTX || {};
            ...
            const ITEM_USE_TABLE = {
                ...
                // 状态类物品：使用后写入状态池，下次匹配检定自动优势并消耗
                '松茸':     { status: [{key:'adv:str', name:'力量检定优势'}, {key:'adv:con', name:'体质检定优势'}], desc: '食用后下次力量/体质检定优势' },
                '魔法泉水': { status: [{key:'adv:int', name:'智力检定优势'}], desc: '饮用后下次智力相关检定优势' },
            };
