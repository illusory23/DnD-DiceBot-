...
class Notification(db.Model):
    """消息通知（2026-08-16 新增）：被评论/被点赞提醒。

    type: post_comment | workshop_comment | post_like | workshop_like
    ...
    actor = db.Column(db.String(100), default='')   # 操作者用户名
    content = db.Column(db.Text, default='')        # 通知文本
